  ...
  const skills: Skill[] = [
    {
      ...
      skill: 'JavaScript',
      experience: '5 years',
      description: 'Proficient in ES6+, experienced in building web applications.',
    },
    {
      icon: jsIcon,
      skill: 'Node.js',
    ...
    },
    {
      ...
      skill: 'TypeScript',
      experience: '3 years',
      description: 'Strong understanding of static typing and advanced TypeScript features.',
    },
    {
      icon: jsIcon,
      skill: 'Next.js',
    ...
    },
    {
      ...
      skill: 'Nest.js',
      experience: '2 years',
      description: 'Proficient in building scalable and maintainable backend applications.',
    },
    {
      icon: figmaIcon,
      skill: 'Figma',
    ...
    return (
      ...
      >
        <div className="flex items-center">
          <img src={skill.icon} alt={`${skill.skill} icon`} className="w-12 h-12 mr-4" />
          <div>
            <span className="text-xl font-semibold text-gray-700">{skill.skill}</span>
